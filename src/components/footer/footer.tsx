    ...
    return (
        <SlideIn className="[grid-column:content]">
            <footer className="mt-24 min-h-[30svh]">
                <Separator />
                <div className="my-12 px-2 sm:px-8">
                    ...
                    <div className="mt-4 flex flex-wrap gap-x-6 gap-y-2 *:flex *:items-center *:gap-2 *:text-muted-foreground *:dark:text-muted">
                        <Button variant={"link"} asChild className="hover:!text-foreground">
                            <a href="https://github.com/Todo-Company/TodoWEB">
                                <GitHubIcon />
                                Project GitHub
                            </a>
                        </Button>
                        <Button variant={"link"} asChild className="group/buymeacoffeelink hover:!text-foreground">
                            <a href="https://www.buymeacoffee.com/TODO.Company">
                                <BuyMeACoffeeIcon />
                                Buy us a coffee
                            </a>
                        </Button>
                        <Button variant={"link"} asChild className="hover:!text-foreground">
                            <a href="https://github.com/Ortieez">
                                <GitHubIcon />
                                BackEnd Developer
                            </a>
                        </Button>
                        <Button variant={"link"} asChild className="hover:!text-foreground">
                            <a href="https://github.com/ARCADEGC">
                                <GitHubIcon />
                                FrontEnd Developer
                            </a>
                        </Button>
...
const GitHubIcon = () => (
    <svg
        ...
        className="lucide lucide-github size-4 fill-none stroke-current stroke-2"
    >
...
const BuyMeACoffeeIcon = () => (
    <svg className="size-4" viewBox="0 0 884 1279" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            d="m791.109 297.518-.878-.516-2.03-.619a4.83 4.83 0 0 0 2.908 1.135m12.787 91.373-.98.275zm-12.412-91.514a2 2 0 0 1-.366-.087 1.4 1.4 0 0 0 0 .244.74.74 0 0 0 .366-.157"
            className="fill-current"
        />
        <path
            d="M791.113 297.529h.131v-.082zm11.998 91.197 1.48-.843.551-.31.499-.533a8.5 8.5 0 0 0-2.53 1.686m-9.442-89.211-1.446-1.377-.98-.533a4.08 4.08 0 0 0 2.426 1.91m-363.65 886.665a7.55 7.55 0 0 0-2.943 2.27l.912-.58c.62-.57 1.497-1.24 2.031-1.69m211.168-41.55c0-1.3-.636-1.06-.482 3.58 0-.37.155-.75.224-1.11.086-.83.155-1.64.258-2.47m-21.903 41.55a7.55 7.55 0 0 0-2.942 2.27l.912-.58c.619-.57 1.497-1.24 2.03-1.69m-337.98 9.88a6.3 6.3 0 0 0-3.097-1.45c.929.45 1.858.9 2.477 1.24zm-33.463-32.05a9.9 9.9 0 0 0-1.222-3.85c.474 1.23.87 2.5 1.187 3.78z"
            className="fill-current"
        />
        <path
            ...
            className="fill-current group-hover/buymeacoffeelink:fill-[#FD0]"
        />
        <path d="m78.689 386.132.79.74.517.31a8 8 0 0 0-1.307-1.05" className="fill-current" />
        <path
