...
export function Homepage() {
    return (
        <div className="relative grid grid-cols-[inherit] [grid-column:page]">
            <SlideIn className="absolute z-0 h-[calc(100svh_-_74px)] w-full overflow-clip [grid-column:_page] [mask-image:radial-gradient(hsl(var(--background)),_transparent_80%)] ">
            ...
            <SlideIn className="relative z-10 mt-12 grid h-fit max-w-[60ch] py-20 delay-100 [grid-column:_content]">
